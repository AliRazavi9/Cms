<div id="right-nav">
    <div class="user-image-status">
        <img style="margin: 10px auto" class="img-circle img-responsive" width="80" height="80"
             src="img/vahid.jpeg"/>
        <p style="text-align: center;color: #fff">وحید صالحی</p>
    ...
    <ul id="menu" class="collapse">
        ...
        <li class="panel ">
            ...
            <ul class="collapse" id="post-management">
                <li class=""><a href="allpost.php"><i class="icon-angle-left"></i> کل مطالب </a></li>
                <li class=""><a href="new-post.php"><i class="icon-angle-left"></i> افزودن نوشته </a></li>
                <li class=""><a href="cats.php"><i class="icon-angle-left"></i> دسته ها </a></li>
                <li class=""><a href="create_series.php"><i class="icon-angle-left"></i>دوره های آموزشی</a></li>
            </ul>
        </li>
        <li class="panel ">
            <a href="comments.php" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed"
        ...
        <li class="panel">
            ...
            <ul class="collapse" id="progress_course">
                ...
                <li><a href="manage_progress.php"><i class="icon-angle-left"></i> مدیریت پیشرفت دوره ها </a></li>
