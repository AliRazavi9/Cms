            ...
            <div class="col-sm-2 col-md-2 col-lg-2" id="profile-menu">
                <ul class="nav nav-tabs tabs-left" id="profile-nav">
                    ...
                    <li><a href="#profile-user-all-tickets" data-toggle="tab"><i class="material-icons">record_voice_over</i>پیام
                            های
                            شما</a></li>
                    <li><a href="#profile-user-transaction" data-toggle="tab"><i
                                    class="material-icons">monetization_on</i>تراکنش
                            های شما</a></li>
                </ul>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home-profile">
                        <div class="profile-img-holder text-center">
                            <img class="img-circle" src="assets/img/gravatar.png" width="130" height="130">
                        </div>
                    ...
                    <div class="tab-pane" id="profile-course-list">
                        <ul class="list-group">
                            <li><a href="#"><i class="material-icons">import_contacts</i>دوره آموزش اسکریپت نویس PHP</a>
                            </li>
                            <li><a href="#"><i class="material-icons">import_contacts</i>دوره آموزش اسکریپت نویس PHP</a>
                            </li>
                            <li><a href="#"><i class="material-icons">import_contacts</i>دوره آموزش اسکریپت نویس PHP</a>
                    ...
                    <div class="tab-pane " id="profile-user-all-tickets">
                        ...
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-info">
                                ...
                                <div id="section1" class="panel-collapse collapse in custom-panel-collapse">
                                    <div class="ticket-details-wrapper">
                                        <img class="img-circle sender-ticket-image" src="assets/img/vahid.jpeg"><span>ارسال شده در تاریخ : 20-12-1396</span><span><a
                                                    href="#ticket-answer1" class="btn btn-warning send-answer-ticket"
                                                    data-toggle="collapse">ارسال پاسخ</a></span>

                                        <div class="ticket-text">
                                            <p>
                                                تشکر میکنم از جناب صالحی بابت زمان و انرژی که گذاشتن بابت تهیه این دوره
                                                بی نظیر، انقدر مطالب کامل و با جزئیات بیان شده که دیدنش برای چند بار هم
                                                لذت بخشه، واقعا با همه وجود خوشحالم که این دروه رو تهیه کردم امیدوارم
                                                جناب صالحی و تیم 7لرن به همین صورت فعالیت خودشونو ادامه بدن
                                            </p>
                                        </div>
                                            ...
                                            <form class="">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control"
                                                              rows="10">dadasdasdasdasdsad</textarea>
                                                </div>
                                    ...
                                    <div class="ticket-details-wrapper">
                                        <img class="img-circle sender-ticket-image" src="assets/img/vahid.jpeg"><span>ارسال شده در تاریخ : 20-12-1396</span><span><a
                                                    href="#ticket-answer2" class="btn btn-warning send-answer-ticket"
                                                    data-toggle="collapse">ارسال پاسخ</a></span>
                                    ...
                                    <div class="ticket-details-wrapper">
                                        <img class="img-circle sender-ticket-image" src="assets/img/vahid.jpeg"><span>ارسال شده در تاریخ : 20-12-1396</span><span><a
                                                    href="#ticket-answer3" class="btn btn-warning send-answer-ticket"
                                                    data-toggle="collapse">ارسال پاسخ</a></span>
                                    ...
                                    <div class="ticket-details-wrapper">
                                        <img class="img-circle sender-ticket-image" src="assets/img/vahid.jpeg"><span>ارسال شده در تاریخ : 20-12-1396</span><span><a
                                                    href="#ticket-answer4" class="btn btn-warning send-answer-ticket"
                                                    data-toggle="collapse">ارسال پاسخ</a></span>
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading" id="">
                                    <a href="#section2" data-toggle="collapse" data-parent="#accordion">موضوع تیکت :
                                        سوال در مورد نحوه شرکت در دوره</a>
                                </div>
                                <div id="section2" class="panel-collapse collapse custom-panel-collapse">
                                    dasdasdasdasdasdas
                                </div>
                            </div>
                        </div>
